Rails.application.routes.draw do
  ...
  post("/insert_director_record", { :controller => "director", :action => "create"})
  ...
  get("/modify_movie_record/:the_id", { :controller => "movies", :action => "update"})
  ...
  post("/modify_actor_record/:the_id", { :controller => "actor", :action => "update" })
end
